...
public class CalculateCredits {
    public double CalculateCredit(String[] Values, RomanNumeralCalculation romanCalculate){
    ...
    public void CalculateCreditPerItem(String[] Output, RomanNumeralCalculation romanCalculate){
